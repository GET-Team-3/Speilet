const model = {
    ...
    survey: [
        ...
        {
            theme: 'Beste praksis er standard',
            row: [
        ...
        {
            theme: 'Selvledelse og god daglig drift',
            row: [
        ...
        {
            theme: 'Kontinuerlig forbedring. Litt bedre hver dag',
            row: [
